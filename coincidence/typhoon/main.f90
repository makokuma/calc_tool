program main
    ...
    do
        ...
        !if criteria CE1 or CE2 meet, judge as typhoon cases
        if ((ce1_flag == 1) .or. (ce2_flag == 1)) then
            print *, '========================================'
            print *, trim(target_hrid), ' : typhoon cases'
            print *, '========================================'
        else
            print *, '========================================'
            print *, trim(target_hrid), ' : not typhoon cases'
            print *, '========================================'
        endif
